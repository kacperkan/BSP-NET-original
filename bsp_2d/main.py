...
flags.DEFINE_integer(
    "iteration",
    0,
    "Iteration to train. Either epoch or iteration need to be zero [0]",
)
flags.DEFINE_float(
    "learning_rate", 0.00002, "Learning rate for adam [0.00002]"
)
...
flags.DEFINE_integer(
    "sample_vox_size", 64, "Voxel resolution for coarse-to-fine training [64]"
)
...
flags.DEFINE_boolean("mse", False, "True for calculating MSE")
FLAGS = flags.FLAGS
